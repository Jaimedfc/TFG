      ...
      if(this.props.index === 0){
        if(this.props.type === "Animal"){
          return(<Container>
            <ul>
              ...
              <li><Input plaintext readOnly value={"Animal nacido el "+dateIn.getDate()+ " de "+mL[dateIn.getMonth()]+" del año "+dateIn.getFullYear()}/></li>
              <li><Input plaintext readOnly value={"El manipulador lo transportó el "+dateOut.getDate()+ " de "+mL[dateOut.getMonth()]+" del año "+dateOut.getFullYear() + " por " +_trsp}/></li>
            </ul>
            <hr/>
        </Container>);
          ...
          return(<Container>
            <ul>
              ...
              <li><Input plaintext readOnly value={"Cultivo plantado el "+dateIn.getDate()+ " de "+mL[dateIn.getMonth()]+" del año "+dateIn.getFullYear()}/></li>
              <li><Input plaintext readOnly value={"El manipulador lo transportó el "+dateOut.getDate()+ " de "+mL[dateOut.getMonth()]+" del año "+dateOut.getFullYear()+ " por " +_trsp}/></li>
            </ul>
            <hr/>
        </Container>);
          ...
          return(<Container>
            <ul>
              ...
              <li><Input plaintext readOnly value={"Objeto producido el "+dateIn.getDate()+ " de "+mL[dateIn.getMonth()]+" del año "+dateIn.getFullYear()}/></li>
              <li><Input plaintext readOnly value={"El manipulador lo transportó el "+dateOut.getDate()+ " de "+mL[dateOut.getMonth()]+" del año "+dateOut.getFullYear()+ " por " +_trsp}/></li>
            </ul>
            <hr/>
        </Container>);
        ...
        return(<Container>
                <ul>
                  ...
                  <li><Input plaintext readOnly value={"El manipulador lo recibió el "+dateOut.getDate()+ " de "+mL[dateOut.getMonth()]+" del año "+dateOut.getFullYear()}/></li>
                </ul>
            <hr/>
            </Container>);
      }else{
        return(<Container>
              ...
              <li><Input plaintext readOnly value={"El manipulador lo recibió el "+dateIn.getDate()+ " de "+mL[dateIn.getMonth()]+" del año "+dateIn.getFullYear()}/></li>
              <li><Input plaintext readOnly value={"El manipulador lo transportó el "+dateOut.getDate()+ " de "+mL[dateOut.getMonth()]+" del año "+dateOut.getFullYear()+ " por " +_trsp}/></li>
            </ul>
            <hr/>
            </Container>);
